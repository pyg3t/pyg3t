# -*- coding: utf-8 -*-
#
# PyG3T documentation build configuration file, created by
...
project = u'PyG3T'
copyright = u'2015, Ask H. Larsen and Kenneth Nielsen'
...
latex_documents = [
  ('index', 'PyG3T.tex', u'PyG3T Documentation',
   u'Ask H. Larsen and Kenneth Nielsen', 'manual'),
]
...
man_pages = [
    ('index', 'pyg3t', u'PyG3T Documentation',
     [u'Ask H. Larsen and Kenneth Nielsen'], 1)
]
...
texinfo_documents = [
  ('index', 'PyG3T', u'PyG3T Documentation',
   u'Ask H. Larsen and Kenneth Nielsen', 'PyG3T', 'One line description of project.',
   'Miscellaneous'),
]
